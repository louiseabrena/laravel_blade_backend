...
<section class="w3-padding">
    ...
    <form method="post" action="/console/education/edit/{{$education->id}}" novalidate class="w3-margin-bottom">
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="text" name="certification" id="certification" value="{{old('certification', $education->certification)}}">
...
<!-- <section class="w3-padding">
    ...
    <form method="post" action="/console/education/edit/{{$education->id}}" novalidate class="w3-margin-bottom">
        ...
        <div class="w3-margin-bottom">
            <label for="institution">Institution:</label>
            <input type="institution" name="institution" id="institution" value="{{old('institution', $education->institution)}}" required>
        ...
        <div class="w3-margin-bottom">
            <label for="certification">Certification:</label>
            <input type="certification" name="certification" id="certification" value="{{old('certification', $education->certification)}}" required>
        ...
        <div class="w3-margin-bottom">
            <label for="description">Description:</label>
            <input type="description" name="description" id="description" value="{{old('description', $education->description)}}" required>
